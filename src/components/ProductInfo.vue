<template>
    <div v-if="this.product" class="w-[390px] xl:w-[1920px] md:w-[834px]">
        ...
        <div class="ml-10 mr-10">
            <h1 class="text-4xl text-center font-bold mb-7 xl:text-6xl xl:text-center xl:mb-10 md:text-6xl md:mb-10 md:text-center">{{product.name}}</h1>
            <h1 class="text-center mb-8 xl:text-2xl xl:text-center xl:mb-10 md:text-2xl md:mb-10 md:text-center">{{product.description}}</h1>
