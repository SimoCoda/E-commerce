<template>
    <div class="flex bg-white w-96 h-16 border-b-2 border-black mb-5 fixed">
        ...
        <div v-if="cartStore.items != 0">
            <img src="../assets/image/cart.png" class="h-8 m-1 relative left-[305px] top-1" @click="goCart"/>
            <div class="absolute left-[362px] top-4 h-4 w-4 text-center rounded-full items-center justify-center bg-red-600 text-white text-xs">{{cartStore.cart.cartLength}}</div>
        </div>
        <div v-else>
